...
public class ProfileGelleryAdapter extends RecyclerView.Adapter<ProfileGelleryAdapter.ViewHolder>
             implements OnProfileGalleryClickListener {

    ArrayList<PictureInfo> items = new ArrayList<PictureInfo>();
    OnProfileGalleryClickListener listener;

    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
            View itemView = inflater.inflate(R.layout.profile_item, viewGroup, false);
    ...
    public void setOnItemClickListener(OnProfileGalleryClickListener listener) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, final OnProfileGalleryClickListener listener) {
            super(itemView);
