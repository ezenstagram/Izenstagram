...
import com.example.izenstargram.like.adapter.UserRecyclerAdapter;
import com.example.izenstargram.like.bean.NotifiInfo;
import com.example.izenstargram.login.JoinFirstActivity;
...
public class UsersFragment extends Fragment {
    ...
    String URL = "http://192.168.0.13:8080/project/myNotifiInfo.do";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.like_users_layout, container, false);
        ...
        list = new ArrayList<>();
        adapter = new UserRecyclerAdapter(list, getActivity());
