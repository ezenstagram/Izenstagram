...
//        client.post(profile_URL, params,response);
    ...
    class Profilephoto extends  AsyncHttpResponseHandler{
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            ...
            try {
                ...
                profile_photo_name = jsonObject.getString("profile_photo");
            } catch (JSONException e) {
                e.printStackTrace();
            }
            String photoPath_profile="http://192.168.0.13:8080/image/storage/"+profile_photo_name;
            imageLoader.displayImage( photoPath_profile, profile_picture, options_profile);
        }
